        ...
        <?php 
            ...
            if($_SERVER["REQUEST_METHOD"]=="POST"){
                if($_POST["envio"] == "Cerrar Sesion"){
                    ...
                    if($usuario == "Invitado" || sqlPedidoRealizado($_POST["idProducto"],$idCesta)){
                        switch(true){
                            case $usuario == "Invitado":echo "<p class='text-bg-info mt-4'>Tiene que iniciar sesion para poder comprar</p>";break;
                            case sqlPedidoRealizado($_POST["idProducto"],$idCesta): echo "<p class='text-bg-info mt-4'>Ya ha añadido este producto</p>";break;
                        }                        
                    }else{
